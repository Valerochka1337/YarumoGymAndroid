...
| **Календарь** | Просматривать историю, планировать занятия и подключать Google Calendar. |
...
- Google Calendar подключается отдельно. AI-функциям нужны сеть и соответствующая настройка
